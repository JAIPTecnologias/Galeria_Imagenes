...
categorias.forEach((categoria) => {
    ...
    contenedorCategorias$1.append(nuevaCategoria); //Aqui se cargan las categorias al DOM
...
const cargarImagen = (id, nombre, ruta, descripcion) => {
    ...
    galeria$4.querySelector('.galeria__titulo').innerHTML = nombre;
    galeria$4.querySelector('.galeria__descripcion-imagen-activa').innerHTML = descripcion;
...
contenedorCategorias.addEventListener('click', (e) => {
    ...
    if(e.target.closest('a')){//Closest busca elementos desde abajo hacia arriba
       ...
       // Agregamos la clase active al primer elemento.
		galeria$3.querySelector('.galeria__carousel-image').classList.add('galeria__carousel-slide--active');
